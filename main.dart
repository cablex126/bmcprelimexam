...
class MyAppState extends State<MyApp> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _resultMessage.isEmpty ? 'Result will be shown here' : _resultMessage,
                  style: labelStyle,
  ...
  void convert(double value, String from, String to) {
    ...
    if (result == 0) {
      ...
      _resultMessage = '${_numberFrom.toString()} $_startMeasure are ${result.toStringAsFixed(2)} $_convertedMeasure';
    }
    setState(() {
